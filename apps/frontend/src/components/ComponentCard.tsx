...
export default function ComponentCard({ component }: { component: Component }) {
  ...
  return (
    <div className="text-primary-950 bg-primary-100/50 border-primary-300 dark:text-primary-50 dark:bg-primary-300/30 flex h-[calc(16rem*1.5)] w-[16rem] max-w-[16rem] flex-col justify-evenly rounded-3xl border p-4 shadow-md backdrop-blur-md transition-transform duration-300 ease-in-out hover:scale-[101%]">
      <img
