...
export default function StickyNavbar() {
  ...
  const activeIndex = routes.findIndex(val => val.path == location.pathname);
  const {
    navRef,
    itemRefs,
    indicatorStyle,
  ...
  return (
    <header className="fixed flex w-full items-center justify-between rounded-full bg-transparent pt-4">
      <motion.nav
        ref={navRef}
