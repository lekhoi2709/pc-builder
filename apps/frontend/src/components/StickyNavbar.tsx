...
const StickyNavbar = memo(
  ({
    ...
    return (
      <motion.header
        className={twMerge(
          'border-primary-600/50 dark:border-primary-400/50 font-saira max-w-screen border-1 z-50 items-center justify-between rounded-full bg-transparent px-4 backdrop-blur-sm xl:flex',
          className
        )}
