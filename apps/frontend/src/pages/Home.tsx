...
function WorkflowSection() {
  ...
  return (
    <motion.section
      ...
      className="font-saira border-b border-gray-200 py-12 md:py-20 dark:border-gray-800"
    >
      <div className="mb-10 text-center md:mb-16">
        <motion.h2
          variants={itemVariants}
          className="text-dark dark:text-light mb-4 text-3xl font-bold tracking-tight md:text-4xl"
        >
          The Workflow
        </motion.h2>
        <motion.p
          variants={itemVariants}
          className="mx-auto max-w-2xl px-4 text-gray-500 dark:text-gray-400"
        >
      ...
      <div className="relative mx-auto grid max-w-5xl grid-cols-1 gap-10 px-4 md:grid-cols-3 md:gap-8 md:px-0">
        <motion.div
          variants={itemVariants}
          className="bg-linear-to-r via-accent-400 dark:via-accent-100 absolute left-[16%] right-[16%] top-12 z-0 hidden h-px from-transparent to-transparent md:block"
        ></motion.div>
        <div className="relative z-10 flex flex-col items-center text-center">
          <motion.div
            variants={itemVariants}
            className="dark:hover:border-primary-500 hover:border-primary-200 bg-light-elevated group mb-4 flex h-20 w-20 items-center justify-center rounded-full border border-gray-300 shadow-lg transition-colors duration-300 md:mb-6 md:h-24 md:w-24 dark:border-[#232f48] dark:bg-[#151c2a]"
          >
          ...
          <motion.h3
            variants={itemVariants}
            className="text-dark dark:text-light mb-2 text-xl font-bold md:mb-3"
          >
            Specification
          </motion.h3>
          <motion.p
            variants={itemVariants}
            className="max-w-xs text-sm leading-relaxed text-gray-500 dark:text-gray-400"
          >
